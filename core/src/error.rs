...
pub enum Error {
    ...
    #[error(transparent)]
    WalletError(#[from] waglayla_wallet_core::error::Error),
    ...
    #[error(transparent)]
    WrpcClientError(#[from] waglayla_wrpc_client::error::Error),
    ...
    #[error(transparent)]
    RpcError(#[from] waglayla_rpc_core::error::RpcError),
    ...
    #[error("Metrics: {0}")]
    Metrics(#[from] waglayla_metrics_core::error::Error),
...
// impl From<waglayla_wallet_core::error::Error> for Error {
//     fn from(err: waglayla_wallet_core::error::Error) -> Self {
