...
// static MAINNET_NETWORK_PARAMS: NetworkParams = NetworkParams {
...
// };
// static TESTNET10_NETWORK_PARAMS: NetworkParams = NetworkParams {
//   coinbase_transaction_maturity_period_daa: 100,
//   coinbase_transaction_stasis_period_daa: 50,
//   user_transaction_maturity_period_daa: 10,
//   mass_combination_strategy: MassCombinationStrategy::Add,
...
// };
// static TESTNET11_NETWORK_PARAMS: NetworkParams = NetworkParams {
...
impl From<Network> for NetworkParams {
    fn from(network: Network) -> NetworkParams {
        NetworkParams::from(NetworkId::from(network)) // Delegate to the existing `From<NetworkId>`
    }
}

impl From<&Network> for NetworkParams {
    fn from(network: &Network) -> NetworkParams {
        NetworkParams::from(NetworkId::from(*network)) // Delegate similarly for references
    }
}
