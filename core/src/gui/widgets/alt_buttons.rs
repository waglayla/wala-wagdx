...
pub fn dx_button(      
  ...
  move |ui: &mut Ui| dx_button_ui(ui, text.into(), font_size, padding, vertical_offset, kind)
}
...
pub fn dx_button_enabled(      
  ...
  move |ui: &mut Ui| dx_button_enabled_ui(ui, enabled, text.into(), font_size, padding, vertical_offset, kind)
}
...
impl ButtonExt for Ui {
    ...
    fn dx_button(
      ...
      self.add(dx_button(text, font_size, padding, vertical_offset, kind))
    }
    ...
    fn dx_large_button(&mut self, text: impl Into<String>) -> Response {
      self.add(dx_button(text, 24.0, 6.0, -12.0, Default::default()))
    }

    fn dx_large_button_enabled(&mut self, enabled: bool, text: impl Into<String>) -> Response {
      self.add(dx_button_enabled(enabled, text, 24.0, 6.0, -12.0, Default::default()))
    }
}
